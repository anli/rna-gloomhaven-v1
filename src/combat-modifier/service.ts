...
class CARD {
  ...
  static PLUS_ZERO_STUN = {name: '+0 STUN', imageUrl: 'https://i.imgur.com/OCtj089.png'};
  static PLUS_ONE_WOUND = {name: '+1 WOUND', imageUrl: 'https://i.imgur.com/qz3PJWi.png'};
  static PLUS_ONE_IMMOBILIZE = {name: '+1 IMMOBILIZE', imageUrl: 'https://i.imgur.com/2WxjK6P.png'};
  static PLUS_ONE_CURSE = {name: '+1 CURSE', imageUrl: 'https://i.imgur.com/ZjGMg4V.png'};
  static PLUS_TWO_FIRE = {name: '+2 FIRE', imageUrl: 'https://i.imgur.com/ihyEuHA.png'};
  static PLUS_TWO_ICE = {name: '+2 ICE', imageUrl: 'https://i.imgur.com/8NKtTFi.png'};
  static ROLLING_EARTH = {name: '⤵ EARTH', imageUrl: 'https://i.imgur.com/1W2T8Rx.png'};
  static ROLLING_AIR = {name: '⤵ AIR', imageUrl: 'https://i.imgur.com/Yfie493.png'};
  static ROLLING_LIGHT = {name: '⤵ LIGHT', imageUrl: 'https://i.imgur.com/XEKY9Wo.png'};
  static ROLLING_DARK = {name: '⤵ DARK', imageUrl: 'https://i.imgur.com/eq7Kd9c.png'};
}

const PERK = {
  REMOVE_FOUR_PLUS_ZERO: {name: 'Remove four +0 cards', totalCount: 1, activeCount: 0},
  ...
  ADD_ONE_PLUS_ZERO_STUN: {name: 'Add one +0 STUN card', totalCount: 1, activeCount: 0},
  ADD_ONE_PLUS_ONE_WOUND: {name: 'Add one +1 WOUND card', totalCount: 1, activeCount: 0},
  ADD_ONE_PLUS_ONE_IMMOBILIZE: {name: 'Add one +1 IMMOBILIZE card', totalCount: 1, activeCount: 0},
  ADD_ONE_PLUS_ONE_CURSE: {name: 'Add one +1 CURSE card', totalCount: 1, activeCount: 0},
  ADD_ONE_PLUS_TWO_FIRE: {name: 'Add one +2 FIRE card', totalCount: 1, activeCount: 0},
  ADD_ONE_PLUS_TWO_ICE: {name: 'Add one +2 ICE card', totalCount: 1, activeCount: 0},
